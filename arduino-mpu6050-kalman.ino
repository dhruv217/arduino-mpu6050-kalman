...
#define motor_ctr_1 8
#define motor_ctr_2 9
#define motor_ctr_3 10
#define motor_ctr_4 11

/*
#Forward
  motor_ctr (1 = HIGH, 2 = LOW, 3 = HIGH, 4 = LOW)
#Reverse
  motor_ctr (1 = LOW, 2 = HIGH, 3 = LOW, 4 = HIGH)
#Left
  motor_ctr (1 = HIGH, 2 = LOW, 3 = LOW, 4 = LOW)
#Right
  motor_ctr (1 = LOW, 2 = LOW, 3 = HIGH, 4 = LOW) 
*/
...
void setup()
{
    ...
    // motor ctr init
    pinMode(motor_ctr_1, OUTPUT);  
    pinMode(motor_ctr_2, OUTPUT);  
    pinMode(motor_ctr_3, OUTPUT);  
    pinMode(motor_ctr_4, OUTPUT); 
     
    digitalWrite(motor_ctr_1, LOW);
    digitalWrite(motor_ctr_2, LOW);
    digitalWrite(motor_ctr_3, LOW);
    digitalWrite(motor_ctr_4, LOW);
}
...
void loop()
{
    ...
    // Center
    if(pitch > -15 && pitch < 15 && roll > -25 && roll < 25){
      digitalWrite(motor_ctr_1, LOW);
      digitalWrite(motor_ctr_2, LOW);
      digitalWrite(motor_ctr_3, LOW);
      digitalWrite(motor_ctr_4, LOW);
    ...
    // Forward
    if(pitch < -15 && roll > -25 && roll < 25){
      digitalWrite(motor_ctr_1, HIGH);
      digitalWrite(motor_ctr_2, LOW);
      digitalWrite(motor_ctr_3, HIGH);
      digitalWrite(motor_ctr_4, LOW);
    ...
    if(pitch > 15 && roll > -25 && roll < 25){
      digitalWrite(motor_ctr_1, LOW);
      digitalWrite(motor_ctr_2, HIGH);
      digitalWrite(motor_ctr_3, LOW);
      digitalWrite(motor_ctr_4, HIGH);
      Serial.println("Reverse");
    }

    // Left
    if(roll > 20 && pitch > -15 && pitch < 15){
      digitalWrite(motor_ctr_1, HIGH);
      digitalWrite(motor_ctr_2, LOW);
      digitalWrite(motor_ctr_3, LOW);
      digitalWrite(motor_ctr_4, LOW);
